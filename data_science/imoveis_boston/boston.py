...
#subtítulo
st.markdown("Este é um Data App utilizado para exibir a solução de Machine Learning para o problema de predição de valores imóveis de Boston")
...
ptratio = st.sidebar.number_input("Índices de alunos para professores", value=data.PTRATIO.mean())
b = st.sidebar.number_input("Proporção de pessoas com descendência afro-americana", value=data.B.mean())
